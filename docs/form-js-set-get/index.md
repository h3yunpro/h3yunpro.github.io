---
url: 'https://h3yunpro.github.io/docs/form-js-set-get/index.md'
---
...
* 人员单选控件的值是用户Id，这个Id可以通过SQL查询 [系统-用户表 H\_User](/docs/database/#系统-用户表-h-user) 表来获取

* 人员单选控件的值是部门Id，这个Id可以通过SQL查询 [系统-部门表 H\_Organizationunit](/docs/database/#系统-部门表-h-organizationunit) 表来获取
...
* 人员多选控件的值是用户Id的字符串数组，这个Id可以通过SQL查询 [系统-用户表 H\_User](/docs/database/#系统-用户表-h-user) 表来获取

* 人员多选控件的值是部门Id的字符串数组，这个Id可以通过SQL查询 [系统-部门表 H\_Organizationunit](/docs/database/#系统-部门表-h-organizationunit) 表来获取
